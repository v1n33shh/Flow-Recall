 ...
 * pointer-events-none so it never itself intercepts the next tap. Uses the
 * reader-highlight token (blue), not accent - see globals.css for why. */
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-30" aria-hidden="true">
      {rects.map((rect, i) => (
        <div
          key={i}
          className="absolute rounded-[3px] bg-reader-highlight/35"
